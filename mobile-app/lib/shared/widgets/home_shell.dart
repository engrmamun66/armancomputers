...
/// reached through "More" (see more_sheet.dart) as a full-screen push.
/// Purchase always shows (left of Sales) regardless of role.
class HomeShell extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final routes = ['/dashboard', '/products', '/purchases', '/sales'];
