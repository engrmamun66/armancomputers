    ...
    <AppLayout>
        ...
        <form v-else class="space-y-6" @submit.prevent="submit">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" :disabled="saving" class="px-4 py-2 text-sm rounded-md bg-primary-600 text-onbrand hover:bg-primary-700 disabled:opacity-60">
        ...
        <Modal v-model="showCustomerModal" title="Add New Customer" size="sm">
            ...
            <template #footer>
                ...
                <button type="button" :disabled="savingCustomer" class="px-4 py-2 text-sm rounded-md bg-primary-600 text-onbrand hover:bg-primary-700 disabled:opacity-60" @click="submitCustomerModal">
